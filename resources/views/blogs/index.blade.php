<x-layout>
    <div class="pt-12 h-full bg-[#fafafa]">
        <div class="md:container">
            ...
            <div
                class="flex flex-col items-center px-4 justify-center pt-[100px] sm:gap-6 gap-3"
            >
            ...
            <div
                class="flex pt-20 mt-3 md:mt-7 flex-wrap gap-2 md:gap-4 md:px-4 px-2"
            >
                @unless(count($tags) == 0)
                    @foreach($tags as $tag)
            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="flex flex-col w-full items-center justify-center gap-6">
                    <form action="/moreArticle">
                        <div
                            class="border w-[1000px] rounded-lg sm:h-16 h-9 sm:pl-8 pl-4 py-4 border-hitam-100 flex items-center gap-3 sm:gap-6"
                        >
                            <svg
