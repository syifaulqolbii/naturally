                ...
                <div class="mt-5">
                    ...
                    <div class="border rounded-md border-[#EDEDED] w-full h-auto p-6 flex flex-col gap-5 ml-6 mt-3">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{$event->name}}" placeholder="Max. 10 words" class="border rounded-md border-[#EDEDED] focus:border-[#3C4D27] placeholder-[#9A9A9A] font-work outline-0 px-6 py-3 w-full text-sm" />
                            @error('name')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="flex gap-14">
                            <div>
                                ...
                                <input type="date" name="date" id="date" value="{{date('Y-m-d', strtotime($event->date))}}" class="border border-[#EDEDED] focus:border-[#3C4D27] rounded-md outline-0 font-work px-6 py-3 h-10 text-sm" />
                                @error('date')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" name="quota" id="quota" value="{{$event->quota}}" class="border border-[#EDEDED] focus:border-[#3C4D27] rounded-md font-work placeholder-[#9A9A9A] outline-0 px-6 py-3 h-10 text-sm" placeholder="Min. 10 persons" />
                                @error('quota')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="location" id="location" value="{{$event->location}}" placeholder="Event Location" class="border border-[#EDEDED] focus:border-[#3C4D27] rounded-md font-work placeholder-[#9A9A9A] outline-0 px-6 py-3 h-10 text-sm" placeholder="Min. 10 persons" />
                                @error('location')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div>
                            ...
                            <textarea id="summernote" name="description" class="">{{$event->description}}</textarea>
                            @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
