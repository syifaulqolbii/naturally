<x-layout>
            ...
            <div class="flex justify-between items-end w-full">
                ...
                <form action="/dashboard/activity">
                    <div class="border border-[#3C4D27] rounded-md w-[267px] h-9 flex items-center gap-4 py-2 px-4">
                        ...
                        <<<<<<< HEAD <input name="search" class="search-form font-work text-sm placeholder-[#D8D8D8] w-full h-full border-0" type="text" placeholder="Search activity by title" />
                        =======
                        ...
                        >>>>>>> d4978d06670c7fd44bc5f6cd549848eb99a7bcb5
                    </div>
                </form>
            </div>
            <!-- activity -->
            <div class="flex flex-col pt-12 gap-8">
                <div class="flex gap-10 justify-start flex-wrap w-full">
                    ...
                    <div class="bg-white w-[30%] h-auto flex flex-col justify-between rounded-md shadow-md">
                        <div>
                            <img src="{{$event->image ? asset('storage/'.$event->image) : asset('images/event.png')}}" alt="" class="w-full h-[130px] inset-0 object-cover rounded-t-md" />
                        ...
                        <div class="flex font-work h-[50px] border border-[#F0F0F0]">
                            <a href="#" class="border-r border-[#F0F0F0] flex justify-center items-center py-2 w-1/2">
    ...
    <<<<<<< HEAD <div class="flex mt-9 justify-between font-work items-center w-full">
        <div class="flex">
            <!-- Previous Button -->
            <a href="#" class="flex items-center justify-center px-4 py-2 h-8 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700">
                Previous
            </a>

            <!-- Next Button -->
            <a href="#" class="flex items-center justify-center px-4 py-2 h-8 ml-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700">
                Next
            </a>
            =======
