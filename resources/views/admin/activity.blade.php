                ...
                <div class="flex gap-10 justify-start flex-wrap w-full">
                    @unless ($events->isEmpty())
                        @foreach ($events as $event)
                            <div class="bg-white w-[30%] h-auto flex flex-col rounded-md shadow-md">
                                <img
                                ...
                                <h1 class="text-hitam-300 text-base font-work px-5 py-4 border-b border-[#F0F0F0]">
                                    {{ $event->name }}
                                </h1>
                                <div class="flex font-work h-[50px]">
                                    <a href="#"
